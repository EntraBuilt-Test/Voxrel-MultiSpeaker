...
export function NotificationToast({ notifications, onDismiss, className }: NotificationToastProps) {
        ...
        return (
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              {notification.title && <p className="text-sm font-semibold mb-1">{notification.title}</p>}
