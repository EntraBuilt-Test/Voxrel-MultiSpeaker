...
const routeMap: Record<string, RouteInfo> = {
    "/projects": {
        title: "Dashboard",
        description: "Select a project to manage tasks, users, and assignments."
    },
    "/projects/analytic": {
        title: "Project Analytics",
        description: "Performance dashboard with completion rates, productivity metrics, and detailed project analytics."
    },
    "/task/create": {
        title: "Create Task",
