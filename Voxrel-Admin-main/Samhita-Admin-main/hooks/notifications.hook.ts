...
interface UseNotificationsReturn {
  ...
  showSuccess: (_message: string, _options?: Partial<Notification>) => void;
  showError: (_message: string, _options?: Partial<Notification>) => void;
  showInfo: (_message: string, _options?: Partial<Notification>) => void;
  showWarning: (_message: string, _options?: Partial<Notification>) => void;
