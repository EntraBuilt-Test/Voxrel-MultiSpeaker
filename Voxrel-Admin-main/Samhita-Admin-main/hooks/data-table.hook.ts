...
export interface UseDataTableConfig<T> {
  fetchFn: (_page: number, _limit: number, _filters: Record<string, any>) => Promise<void>;
  itemsPerPage?: number;
...
export interface UseDataTableReturn<T> {
  ...
  handleFilter: (_filterKey: string, _filterValue: any) => void;
  handleFilters: (_filters: Record<string, any>) => void;
