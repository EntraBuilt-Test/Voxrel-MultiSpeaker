...
export const useTaskReview = (projectId?: string) => {
  // State management
  ...
  const buildFilters = useCallback(() => {
    ...
    return {
      ...
      // Filter for SUBMITTED and IN_REVIEW statuses
  ...
  }, [searchQuery, filterValues, sortField, sortOrder, projectId]);
  ...
  const handleApproveTask = useCallback(async (taskId: string, feedback?: string) => {
