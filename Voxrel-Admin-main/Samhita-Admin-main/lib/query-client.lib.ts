...
export const queryKeys = {
  ...
  users: {
    ...
    analyticsDashboard: (dateFrom: string, dateTo: string, limit: number) => [...queryKeys.users.analytics(), 'dashboard', { dateFrom, dateTo, limit }] as const,
    analyticsSummary: (dateFrom: string, dateTo: string) => [...queryKeys.users.analytics(), 'summary', { dateFrom, dateTo }] as const,
    analyticsGrowthTrend: (dateFrom: string, dateTo: string) => [...queryKeys.users.analytics(), 'growthTrend', { dateFrom, dateTo }] as const,
    analyticsTopPerformers: (dateFrom: string, dateTo: string, limit: number) => [...queryKeys.users.analytics(), 'topPerformers', { dateFrom, dateTo, limit }] as const,
