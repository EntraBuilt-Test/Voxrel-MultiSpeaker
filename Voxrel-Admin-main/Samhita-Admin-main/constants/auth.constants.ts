...
export const AUTH_VALIDATION_RULES = {
  ...
  confirmPassword: {
    required: true,
    matchField: 'password', // Updated to match password field in register
  },
  confirmNewPassword: {
    required: true,
...
export type RegisterFormData = typeof AUTH_INITIAL_STATES.register;
