...
import { FileText, ArrowLeft, Plus, Users, CheckCircle2, Loader2 } from "lucide-react";
...
export default function TranscriptionAdminDashboardPage() {
  ...
  return (
    <div className="container mx-auto py-8 px-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
        <Card>
          <CardHeader>
            <CardTitle className="text-lg">Create Transcription Task</CardTitle>
            <CardDescription>Create tasks from uploaded files or approved content</CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <Card>
          <CardHeader>
            <CardTitle className="text-lg">Assign Transcription Task</CardTitle>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Manage all transcription tasks in this project</CardDescription>
        </CardHeader>
        <CardContent>
          {tasks.length === 0 ? (
